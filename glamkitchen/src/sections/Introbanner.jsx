        ...
        >
            ...
            <div className="flex h-96 justify-center items-center h-full text-center text-white relative z-10 px-4">
                <div className="max-w-xl w-full">
                    ...
                    {/* Texts */}
                    <h2 className="text-xl font-semibold mb-2">Stylish, reliable & eco-friendly</h2>
                    <h1 className="text-2xl md:text-3xl font-bold mb-4">
                        Transform your kitchen with <span className='text-flame-500'> Glam Your Kitchen</span>'s premium kitchenware.
                    </h1>
                    <a
                        href="#shop"
